"""
Django settings for dc_btp_management_portal project.
...
ROOT_URLCONF = 'dc_btp_management_portal.urls'
...
WSGI_APPLICATION = 'dc_btp_management_portal.wsgi.application'
